...
def run_brute_force():
    ...
    try:
       ...
       bouton_recherche = Button(frame_centre, text="Rechercher", fg=FG_COLOR, bg=BUTTON_COLOR, font=custom_font, activebackground=BUTTON_ACTIVE_COLOR, command=rechercher_mot, width=150)
       bouton_recherche.pack(pady=5)
